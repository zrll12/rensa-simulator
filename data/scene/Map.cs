...
public class Map {
	...
	public void DisplayMapInfo() {
		GodotLogger.LogInfo($"{Decorations.Length} Decorations");
		GodotLogger.LogInfo($"{Labels.Length} Labels");
		GodotLogger.LogInfo($"{ApproachSigns.Length} Approach Signs");
		GodotLogger.LogInfo($"{RouteLights.Length} Route Lights");
		GodotLogger.LogInfo($"{SignalLights.Length} Signal Lights");
		GodotLogger.LogInfo($"{Switches.Length} Switches");
	}
...
public class SwitchDto {
    ...
    public bool IsSignalSwitch { get; init; }
    public bool IsLn { get; init; }
    public bool IsNr { get; init; }
